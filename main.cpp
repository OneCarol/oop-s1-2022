...
animal *v[3]={new vegie("sheep",1),new vegie("cow",3),new vegie("elephant",2)};
...
animal *a[3]= {new hunter("lion",5),new hunter("tiger",7),new hunter("cat",4)};
...
cout<<"\nNumber of animals in the Zoo:"<<obj.get_number_of_animals()<<endl;
